...
public class UserNoEncryptionTest {
    ...
    @Test
    public void searchUsernameOrEmailNoWildcardsSuccessfully() {
        createUser("User", "password", "firstName", "lastName", "user@example.com");

        assertThat(realm.admin().users().search("User", null, null), hasSize(1));
        assertThat(realm.admin().users().search("user@example.com", null, null), hasSize(1));
    }

    @Test
    public void searchUserWithWildcardsSuccessfully() {
        createUser("User", "password", "firstName", "lastName", "user@example.com");
